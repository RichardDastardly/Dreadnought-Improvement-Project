...
* Replaced the mk4 torpedo launcher model with the mk1-3 model for the same reasons as resizing main turrets - you should not have to rebuild a ship for a slightly better torpedo launcher
